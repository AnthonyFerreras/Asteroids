...
namespace Engine
{
	...
	void Ship::ChangeShip()
	{
		...
		m_points.push_back(Math::Vector2(17, -9));
		m_points.push_back(Math::Vector2(19, -7));
		m_points.push_back(Math::Vector2(20, -5));
		...
		m_points.push_back(Math::Vector2(6, 3));
		m_points.push_back(Math::Vector2(3, 4));
		m_points.push_back(Math::Vector2(3, 12));
		m_points.push_back(Math::Vector2(1, 9));
		m_points.push_back(Math::Vector2(-1, 9));
		m_points.push_back(Math::Vector2(-3, 12));
		m_points.push_back(Math::Vector2(-3, 4));
		m_points.push_back(Math::Vector2(-6, 3));
